...
def check_car_battery_voltage(should_start, health, charging_disabled, msg):
  ...
  if charging_disabled and (health is None or health.health.voltage > 11800) and msg.thermal.batteryPercent < 35:
    charging_disabled = False
    os.system('echo "1" > /sys/class/power_supply/battery/charging_enabled')
  elif not charging_disabled and msg.thermal.batteryPercent > 40 and health:
    charging_disabled = True
    os.system('echo "0" > /sys/class/power_supply/battery/charging_enabled')
  elif msg.thermal.batteryCurrent < 0 and msg.thermal.batteryPercent > 40 and health:
    charging_disabled = True
    os.system('echo "0" > /sys/class/power_supply/battery/charging_enabled')
