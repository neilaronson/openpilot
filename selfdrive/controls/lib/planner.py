...
FOUR_BAR_DISTANCE = THREE_BAR_DISTANCE   # in seconds
...
ONE_BAR_PROFILE_BP = [0.0, 4]

TWO_BAR_PROFILE = [1.1, 1.2, 1.4, 1.8]
TWO_BAR_PROFILE_BP = [0, 1, 2, 4.5]

THREE_BAR_PROFILE = [THREE_BAR_DISTANCE, FOUR_BAR_DISTANCE]
THREE_BAR_PROFILE_BP = [0.0, 5]
